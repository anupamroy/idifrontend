<template>
    <header class="wrapper bg-soft-primary">
             <nav class="navbar center-nav transparent position-absolute navbar-expand-lg navbar-dark-inner caret-none">
                 <div class="container flex-lg-row flex-nowrap align-items-center">
                     <div class="navbar-brand w-100"><a href="/"><img class="logo-dark img-fluid logo-size" src="src/img/igbo-red-logo.png" srcset="src/img/igbo-red-logo.png" alt="" /><img class="logo-light img-fluid logo-size" src="src/img/igbo-white.png"   alt="" /></a></div>
                     <div class="navbar-collapse offcanvas-nav">
                         <div class="offcanvas-header d-lg-none d-xl-none">
                             <a href="index.html"><img src="src/img/idi-logo.png" srcset="src/img/idi-logo.png 5x" alt="" /></a>
                             <button type="button" class="btn-close btn-close-white offcanvas-close offcanvas-nav-close" aria-label="Close"></button>
                         </div>
                         <ul class="navbar-nav">
                            <li class="nav-item"><router-link class="nav-link" :to="{name:'Home'}">Home</router-link>	</li>
                            <li class="nav-item"><router-link class="nav-link" :to="{name:'About'}">About Us</router-link>	</li>	
                            <li class="nav-item"><a class="nav-link" href="index.html">Members</a>	</li>
                     ...
                     <div class="navbar-other w-100 d-flex ms-auto">
                        ...
                        <router-link :to="{name:'Registration'}"  class="btn btn-sm btn-primary rounded-pill" v-if="!userName">Register Now</router-link>
                        <router-link :to="{name:'Login'}" class="btn btn-sm btn-warning rounded-pill mx-4" v-if="!userName">Login Now</router-link>
                         <a href="" class="btn btn-sm btn-warning rounded-pill mx-4" v-if="userName" @click="logout">Log Out</a>
                         <div class="mt-2" v-if="userName">Welcome {{userName}}</div>
                         <!-- /.navbar-nav -->
                     </div>
