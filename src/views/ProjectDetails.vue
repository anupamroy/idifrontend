				...
				<article>
					<div class="post-slider mb-8 mb-md-12">
						<div class="basic-slider owl-carousel dots-over" data-nav="true" data-margin="5">
							<div class="item"><img src="src/img/photos/pp7.jpg" class="rounded" alt="" /></div>
							<div class="item"><img src="src/img/photos/pp8.jpg" class="rounded" alt="" /></div>
							<div class="item"><img src="src/img/photos/pp9.jpg" class="rounded" alt="" /></div>
						</div>
						<!-- /.basic-slider -->
					</div>
					<!-- /.post-slider -->
